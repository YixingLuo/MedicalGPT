...
def main():
    ...
    # parser.add_argument('--base_tokenizer_dir', default='D:/LLM-code/ChatGLM/ChatGLM2-6B/model/chatglm2-6b-int4/', type=str, required=True)
    parser.add_argument('--base_tokenizer_dir', default='D:/LLM-code/ChatGLM/ChatGLM2-6B/model/chatglm2-6b-int4/', type=str)
