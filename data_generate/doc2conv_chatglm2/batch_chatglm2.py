...
tokenizer = AutoTokenizer.from_pretrained("D:/LLM-code/LLM_Models/chatglm3-6b", trust_remote_code=True)
model = AutoModel.from_pretrained("D:/LLM-code/LLM_Models/chatglm3-6b", trust_remote_code=True, device='cuda')
model = model.eval()
